 ...
 * This class includes methods to convert the current 
 * instance of a product type into its JSON and XML
 * representations.
 * 
 * @author aclark
 *
...
public class CasProductType {
	 ...
	 * 
	 * @return A JSON-formatted String of the member attributes of the
	...
	public String toJSON() {
		...
		try {
			jOutput = new JSONObject()		
								.put("versionerClass", versionerClass)
	...
	/**
	 * Constructs a JSON-formatted String of only the product type 
	 * metadata items as key-value pairs. 
	 * 
	 * @return The JSON-formatted String of all metadata items 
	...
	public Document toXMLDocument() {	
        ...
        try {
            ...
            Element repositoryPathElem = document.createElement("repositoryPath");
            repositoryPathElem.appendChild(document.createTextNode(repositoryPath));
            typeElem.appendChild(repositoryPathElem);

            Element versionerClassPathElem = document.createElement("versionerClass");
            versionerClassPathElem.appendChild(document.createTextNode(versionerClass));
	...
	/**
	 * @return A Java String containing the XML representation of
	 * 		   the metadata item set for the current Product Type.
	 */
	...
	/**
	 * @param complete If true, convert entire Product Type instance
	 * 		  to its XML representation, else only convert its metadata
	 * 		  items to XML format.
	 * @return A Java String containing the XML structure of the current 
	 * 		   Product Type.
	 */
